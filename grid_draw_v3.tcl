	...
	foreach item $basic_grid_items {
		...
		switch -exact $item {
			...
			"0_0" {
				...
				set i [$can create polygon $coordValues -fill white -outline gold]

				$can create text [gridPos 0] [gridPos 0] \
          -anchor center -text "F"
...
proc draw_path {can location} {

	set first 1

	foreach {xpos ypos} $location {
